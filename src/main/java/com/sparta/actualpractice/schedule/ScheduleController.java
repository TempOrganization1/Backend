package com.sparta.actualpractice.schedule;//package com.sparta.actualproject.controller;
...
public class ScheduleController {
    ...
    public ResponseEntity<?> deleteSchedule(@PathVariable(name = "schedule_id") Long scheduleId , @AuthenticationPrincipal MemberDetailsImpl memberDetails) {

        return scheduleService.deleteSchedule(scheduleId, memberDetails.getMember());
    }
}
